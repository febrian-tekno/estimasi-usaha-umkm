<template>
  <div>
    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 m-4 lg:grid-cols-4 gap-4">
      <div
      ...
      >
        ...
        <div class="p-4">
          ...
          <p class="text-sm text-gray-500">
           <span class="font-bold text-black ">Laba: </span> Rp {{ product.profit.toLocaleString('id-ID') }} / hari
          </p>
