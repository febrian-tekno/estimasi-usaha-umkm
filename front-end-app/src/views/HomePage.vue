    ...
    <div class="container mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
      <div>
        ...
        <p class="text-gray-600 mb-6">
          JualApa adalah platform komunitas yang dirancang untuk membantu pelaku UMKM kuliner menghitung estimasi modal, harga jual, dan potensi keuntungan berdasarkan data bahan, kemasan, dan alat yang diinput komunitas.
        </p>
        <div class="flex gap-4 mb-6">
          <a href="/products/add" class="bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 font-semibold">Mulai Sekarang</a>
    ...
    <div class="container mx-auto  py-16 px-6 grid md:grid-cols-2 gap-10 items-center">
      ...
      <div>
        ...
        <p class="text-gray-600 mb-4">
          JualApa adalah platform komunitas berbasis web yang membantu pelaku UMKM makanan dan minuman membuat perhitungan estimasi modal dan potensi keuntungan secara praktis.
        </p>
    ...
    <section class="py-16" style="background: linear-gradient(to bottom, white 0%, #FED7AA 50%, #FED7AA 50%, white 100%);">
      <div class="max-w-5xl mx-auto px-4 text-center">
        ...
        <p class="text-gray-600 text-sm md:text-base max-w-2xl mx-auto mb-10">
          JualApa membantu UMKM memilih produk kuliner terbaik berdasarkan modal dan kategori. Data diperoleh dari kontribusi komunitas, lengkap dengan estimasi laba dan fitur perencanaan usaha.
        </p>
        ...
        <div class="grid grid-cols-3 gap-4 md:gap-8 text-center">
          ...
          <div class="flex flex-col items-center scale-90 md:scale-100">
            ...
            <p class="text-gray-600 text-xs md:text-sm max-w-xs">Data bahan, kemasan, dan alat diinput pengguna untuk akurasi nyata.</p>
          </div>
          ...
          <div class="flex flex-col items-center scale-90 md:scale-100">
            ...
            <p class="text-gray-600 text-xs md:text-sm max-w-xs">Desain sederhana agar perencanaan usaha lebih cepat dan mudah.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="bg-gray-50 py-16 px-4">
      <div class="max-w-6xl mx-auto text-center">
        ...
        <p class="text-gray-600 mb-10 max-w-2xl mx-auto text-sm md:text-base">
          Berikut beberapa data penting tentang perkembangan UMKM di Indonesia yang bisa menjadi referensi sebelum memulai usaha kuliner.
        </p>
    ...
    <section class="bg-orange-50 py-16">
      <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <p class="text-gray-600 mb-10 max-w-2xl mx-auto">
          Karena setiap langkah bisnis kuliner harus berbasis data komunitas, bukan hanya tebakan. JualApa memberikan dasar perhitungan yang jelas untuk membuat keputusan yang tepat.
        </p>
        <div class="grid md:grid-cols-3 gap-6 text-left">
          ...
          <div class="bg-white shadow-lg p-6 rounded-xl">
            ...
            <p class="text-sm text-gray-600">Didesain khusus untuk pebisnis pemula dan pelaku usaha kuliner skala kecil-menengah.</p>
          </div>
        </div>
      </div>
    </section>
